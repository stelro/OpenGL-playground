...
int main()
{
    ...
    unsigned char* image;
    image = SOIL_load_image("Assets/container2.png", &tex_width, &tex_height, 0, SOIL_LOAD_RGB);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform1i(glGetUniformLocation(objectShader.getShaderProgram(), "material.deffuse"), 0);
